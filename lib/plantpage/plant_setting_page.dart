...
class plant_setting_page extends StatefulWidget {
  const plant_setting_page(
      {Key? key, required this.getName, required this.getEmail})
      : super(key: key);
  ...
  @override
  State<plant_setting_page> createState() => _plant_setting_pageState();
}

class _plant_setting_pageState extends State<plant_setting_page> {
