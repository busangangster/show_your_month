...
class home_setting_page extends StatefulWidget {
  const home_setting_page(
  ...
  @override
  State<home_setting_page> createState() => _home_setting_pageState();
}

class _home_setting_pageState extends State<home_setting_page> {
